...
{{< figure src="remote-browse.jpg" alt="remote-browse" >}}
...
{{< figure src="select-cuic.jpg" alt="select-cuic" >}}
...
{{< figure src="browse-to-node.jpg" alt="browse-to-node" >}}
...
{{< figure src="all-clean.jpg" alt="all-clean" >}}
