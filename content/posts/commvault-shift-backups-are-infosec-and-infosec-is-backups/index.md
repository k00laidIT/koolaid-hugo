...
{{< figure src="commvault-cloud-licensing.png" alt="Commvault Cloud licensing tier comparison chart showing three packages: Foundational Protection, Autonomous Recovery, and Cyber Resilience, with features like immutable storage, threat scanning, AI-driven threat detection, and cyber deception checked across tiers" >}}
