...
This year the content largely focused on 2023 2H releases that will begin trickling out in the next month or so. Showing their cards a little bit the week before Summit Veeam held their [Veeam Resiliency Summit](https://www.veeam.com/veeamon-resiliency-summit), highlighting the focus not only of Veeam but of the industry on the intersection of backup/disaster recovery and information security. As we saw repeatedly at Summit the focus of all products but especially the [Veeam Data Platform](https://www.veeam.com/whats-new-backup-replication.html) 12.1 release (encompassing Veeam Backup and Replication, VeeamONE and Veeam Orchestrator) is how can the products impact your information security stance and specifically tie into the [NIST framework](https://www.nist.gov/cyberframework).

<figure class="wp-block-image size-large">

![](img_1065-1024x565.jpg)
...
There was also quite a bit of content specifically for their Service Provider representatives. As the Vanguard and other programs have matured and with it many of our careers there has been a large shift of members from end user customers to either Service Provider or partner vendor employees. As such the [VCSP](https://www.veeam.com/cloud-connect-service-providers.html) content was a highlight of the week for me, especially with the [recent acquisition by Veeam of CT4’s Cirrus](https://www.veeam.com/newsroom/cirrus.html) platform and what we could learn more about that.
...
PS: My friend [Al Rasheed](https://www.linkedin.com/in/alarasheed/) has done an excellent job of capturing many of the recap posts/content related to this year's Summit, be sure to [check out his post](https://alarasheedblog.wordpress.com/2023/11/10/veeam-100-summit-recap-prague-2023/) if you'd like to learn more about the event.