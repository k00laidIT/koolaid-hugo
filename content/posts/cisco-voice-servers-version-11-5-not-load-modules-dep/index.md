...
![VMware VM settings showing Boot Options with Force BIOS Setup enabled and CD/DVD drive attached and connected at boot](2.force-bios-150x150.png)
...
![VMware Remote Console showing Phoenix BIOS boot order screen with CD-ROM set as the first boot device](3.-boot-to-cd-150x150.png)
...
![Cisco Unified Communications Manager 11.5 Recovery Disk boot menu screen](4.-Rescue-CD-150x150.png)
...
![Linux bash prompt showing find and ls -lh commands confirming the initramfs file is undersized at approximately 13 MB](5.-Verify-corrupt-file-150x150.png)
...
![Linux bash prompt showing VMware Tools reinstallation output and ls -lh confirming initramfs file is now correctly sized at approximately 24 MB](6.-after-vmware-tools-install-150x150.png)
