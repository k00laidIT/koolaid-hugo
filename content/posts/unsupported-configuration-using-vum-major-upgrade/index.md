...
{{< figure src="tasks-and-events-output.jpg" alt="tasks-and-events-output" >}}
...
{{< figure src="scan-after.jpg" alt="scan-after" >}}
...
{{< figure src="original-error.jpg" alt="original-error" >}}
