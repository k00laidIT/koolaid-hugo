...
![](InvalidCertificate-300x126.png)

](InvalidCertificate.png)Step 2: Installing VMware PowerCLI** Yes, this is the hard part... Just kidding! It's just like on Windows, enter the simple one-liner to install all available modules. ```
