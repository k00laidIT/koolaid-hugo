...
{{< figure src="orca-open-file.png" alt="orca-open-file" >}}
...
{{< figure src="1.-orca-find-item.png" alt="1-orca-find-item" >}}
...
{{< figure src="2.-orca-delete-row.png" alt="2-orca-delete-row" >}}
...
{{< figure src="3.-orca-options.png" alt="3-orca-options" >}}

](3.-orca-options.png) Now simply go to File&gt;Save As... and save as you would any other file. Easy peasy... [

{{< figure src="4.-orca-save-as.png" alt="4-orca-save-as" >}}
...
{{< figure src="5.after_.png" alt="5-after" >}}
